(function($){
    SlideDeckLens['tool-kit-transparent'] = function(slidedeck){
    	
    	var self = this;
        var ns = 'tool-kit-transparent';
    ...
    $(document).ready(function(){
        $('.lens-tool-kit-transparent .slidedeck').each(function(){
            if(typeof($.data(this, 'lens-tool-kit-transparent')) == 'undefined' || $.data(this, 'lens-tool-kit-transparent') == null){
                $.data(this, 'lens-tool-kit-transparent', new SlideDeckLens['tool-kit-transparent'](this));
            }
        });
    });
})(jQuery);